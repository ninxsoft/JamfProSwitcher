...
class ViewController: NSViewController {
  ...
  let jamfPreferencesPath = NSHomeDirectory().replacingOccurrences(of: "/Containers/com.ninxsoft.jamfproswitcher/Data", with: "/Preferences/com.jamfsoftware.jss.plist")
  let preferencesPath = NSHomeDirectory().replacingOccurrences(of: "/Containers/com.ninxsoft.jamfproswitcher/Data", with: "/Preferences/com.ninxsoft.jamfproswitcher.plist")
  ...
  */
  ...
  /**
    Loops through each Jamf Pro Server and attempts to look up the version number, and updates the corresponding table cell view if a version string is found.
  */
